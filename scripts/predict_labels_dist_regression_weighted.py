...
def main(
    ...
    model_path = Path(__file__).parent.parent.joinpath("model", f"{dataset}_{human_model}_{base_model}_labels_dist_regression_weighted_finetuned")
    ...
    save_path = model_path.parent.parent.parent.joinpath("prediction", f"{dataset}_{human_model}_{base_model}_labels_dist_regression_weighted_prediction.csv")
